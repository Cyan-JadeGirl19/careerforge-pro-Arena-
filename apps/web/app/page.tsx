...
const MODULES: Array<{ name: string; desc: string; state: "done" | "progress" | "planned" }> = [
  ...
  { name: "Cover Letter Builder", desc: "Plain, candidate-voiced letters per job.", state: "planned" },
  ...
  { name: "Voice/Video Studio", desc: "Recorded responses with teleprompter.", state: "planned" },
  { name: "Gmail Outreach", desc: "Drafts first, throttled, consent-gated.", state: "planned" },
  { name: "Application Tracker", desc: "Stage pipeline with follow-ups.", state: "planned" },
